...
const mockObj=[{
  ...
  "volumeInfo": {
    ...
    "language": "en",
    "previewLink": "http://books.google.com/books?id=tcSMCwAAQBAJ&printsec=frontcover&dq=harry+potter&hl=&cd=1&source=gbs_api",
...
describe("Gallery", () => {
  ...
  const props={items:[]};
   ...
   it("should render Gallery component with book info", () => {
     const dataProps={items:mockObj};
    const wrapper = shallow(<Gallery {...dataProps} />);
